...
void Game::Init()
{
	...
	perlinMap = std::make_unique<HeightMapPNG>();

	// load shaders
	ResourceManager::LoadShader("terrain.vs", "terrain.fs", "terrain.tcs", "terrain.tes", nullptr, "terrain");
	...
	// load textures
	terrain->LoadHeightmap("simplex_height.png");
	terrain->LoadTexture("ground.png");
	terrain->Build();
